    ...
    <Layout>
      <div className="py-10 max-w-screen-md mx-auto">
        ...
        <p className="text-sm px-2 sm:px-10">
          ...
          Suspendisse quis ipsum non orci condimentum dapibus vel sit amet nibh.
          Nam ac imperdiet eros. Duis tempor, augue ut ornare viverra, odio
          tellus fermentum ex, non venenatis lectus sapien vel diam. Etiam et
          metus porta, ornare quam ut, ultricies sem. Aenean sagittis mauris
          eget neque rutrum, sit amet elementum diam tempor. Nulla lacinia
          euismod tellus vitae ornare. Nunc vitae ornare elit. Etiam cursus
          libero in risus bibendum, id maximus dolor venenatis. Nam mollis
          posuere tristique. Aenean fringilla condimentum magna eu fermentum.
          Nunc non varius est. Morbi sit amet urna massa.
        </p>
      </div>
      <div className="py-10">
        <div
        ...
        <div className="mb-10 lg:mb-0 lg:mr-10 px-2 sm:px-10 md:px-20 lg:px-0">
          <div className="mb-10">
            ...
            <p>
              ...
              Etiam et metus porta, ornare quam ut, ultricies sem.
            </p>
          </div>
          <div>
            <div className="w-max mb-4">
      ...
      <div className="lg:flex items-center lg:mb-20 max-w-screen-xl mx-auto">
        ...
        <div className="mt-5 mb-20 lg:m-0 lg:mr-10 px-2 sm:px-10 lg:px-0 max-w-screen-md lg:max-w-none mx-auto lg:w-1/2">
          ...
          <p className="mb-3">
            ...
            mauris eget neque rutrum, sit amet elementum diam tempor.
          </p>
          <p className="mb-4">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce
            hendrerit lacus vitae nisl porta, eget molestie dui ornare.
